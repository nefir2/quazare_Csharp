...
namespace quazare
{
	class Квазар
	{
		...
		static double Ставка(double все_деньги) //вывод выбора ставки
        {
            ...
            {
			    //вывод меню
				Console.WriteLine($"у вас всего денег: {Math.Floor(все_деньги)}"); //вывод всех денег, без остатка
		...
		{
			if (команда == "/percent" || команда == "/процент" || команда == "/p")
			{
				Br();
				Проценты();
				Br();
			}
			else if (команда == "/правила" || команда == "/rules" || команда == "/r")
			{
				Правила();
				Br();
			}
			else if (команда == "/help" || команда == "/команды" || команда == "/помощь" || команда == "/h")
			{
				Br();
        ...
        { //в последствии превращённый в ловителя команд
			...
			do
			{
				...
				{
					if (ввод[0] == '/') //ожидание получения команды
					{ //команды
						Комманды(ввод);
        ...
        { //=> действие заменяемое на *=
            ...
            { //значение автомата: деньги *= число
                15 => 0.25,
                16 => 0.5,
                17 => 1,
                18 => 1.25,
